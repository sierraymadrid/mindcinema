    ...
    <main className="relative min-h-screen overflow-hidden bg-[#05070b] text-white">
      ...
      <section className="relative z-10 mx-auto flex min-h-screen max-w-7xl items-center justify-center px-6 py-20 sm:px-10">
        <div className="w-full max-w-4xl text-center">
          <p className="mb-6 inline-flex items-center rounded-full border border-white/10 bg-white/5 px-4 py-2 text-[0.7rem] font-medium uppercase tracking-[0.35em] text-[#d8c39b] shadow-[0_0_40px_rgba(216,195,155,0.08)] backdrop-blur">
            Cine para crecer
          </p>
          ...
          <h1 className="mx-auto max-w-4xl text-4xl font-semibold leading-tight tracking-[-0.04em] text-white sm:text-5xl md:text-6xl md:leading-[1.02] lg:text-7xl">
            Encuentra la película que necesitas ahora mismo
          </h1>

          <p className="mx-auto mt-6 max-w-2xl text-base leading-7 text-white/68 sm:text-lg sm:leading-8">
            Para las noches en que no sabes qué ver pero sabes que quieres
            algo con sentido.
          </p>
