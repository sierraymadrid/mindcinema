    ...
    <main className="relative min-h-screen overflow-hidden bg-[#05070b] text-white">
      ...
      <section className="relative z-10 mx-auto flex min-h-screen max-w-4xl items-center justify-center px-6 py-16 sm:px-10 sm:py-20">
        <div className="w-full">
          ...
          <div className="rounded-[28px] border border-white/10 bg-white/[0.03] p-8 text-center shadow-[0_20px_80px_rgba(0,0,0,0.24)] backdrop-blur sm:p-10">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-sm leading-6 text-white/48 sm:text-base">
